...
class Menu: NSMenu {
    init() {
        ...
        //radio1.state = Store.shared.bool(key: "radio", defaultValue: true) ? NSControl.StateValue.on : NSControl.StateValue.off
        radio1.target = self
    ...
    @objc private func playRadio(_ sender: NSMenuItem) {
        let uriRadio = "https://icy.unitedradio.it/rmcweb022"
        Store.shared.set(key: "uri", value: uriRadio)
        Player.shared.play()
    }
